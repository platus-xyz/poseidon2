 ...
 *   - Rows 60-63: full round constants (ending, 4 full rounds)
 */

/** External (full round) MDS diagonal elements minus 1 */
export const MAT_DIAG4_M_1: bigint[] = [
...
/**
 * Round constants: 64 rows x 4 columns.
 * Full rounds use all 4 values; partial rounds only use index 0.
 */
export const RC4: bigint[][] = [
  [
